...
## 分页管理以及调取API时的错误信息
from www.apis import Page, APIValueError, APIResourceNotFoundError, APIPermisssionError, APIError
...
async def api_create_comment(id, request, *, content):
    ...
    if user is None:
        raise APIPermisssionError('Please signin first.')
